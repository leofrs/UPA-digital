...
public class AppointmentService {
    ...
    public Appointment marcarConsulta(Long doctorId, Date date, String description) {
...
//        Pacient pacientEntity = pacientRepository.findById(pacient.getId());
        ...
        boolean isDoctorAvailable = appointmentRepository.existsByDoctorAndDate(doctor, date);
